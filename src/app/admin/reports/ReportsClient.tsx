...
export default function ReportsClient({ userName }: { userName: string }) {
  ...
  const stats = useMemo(() => {
    ...
    return { 
      total, done, percentage, pending, 
      totalAchievementPct: totalPossibleWeight > 0 ? Math.round((totalAchievedWeight / totalPossibleWeight) * 100) : 0,
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10 space-y-6">
      ...
      {/* (The JSX from your previous message goes here) */}
